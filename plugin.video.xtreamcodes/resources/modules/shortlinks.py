...
def Get():
	...
	if not auth=="":
		request  = 'http:///create.php?source=indexpage&url='+m3u+'&submit=Make+TinyURL%21&alias='
		xbmc.log(str(request))
		request2 = 'http:///create.php?source=indexpage&url='+epg+'&submit=Make+TinyURL%21&alias='
